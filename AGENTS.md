...
- Startup image asset repair may remove broken DB references, rebuild missing thumbnails, and remove orphan files. Keep the flow explicit, idempotent, and DB/file-consistency focused.

...
#[cfg(test)]
mod tests {
    use super::{excerpt_around_first_match, normalize_preview_text, truncate_chars};
    ...
    #[test]
    fn excerpt_trims_query_before_matching() {
        let text = "foo bar baz";
        assert_eq!(excerpt_around_first_match(text, " bar ", 7), "…bar ba…");
    }
}
